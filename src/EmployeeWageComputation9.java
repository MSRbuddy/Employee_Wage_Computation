public class EmployeeWageComputation9
{
    ...
    EmployeeWageComputation9(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
    ...
    {
        EmployeeWageComputation9 google = new EmployeeWageComputation9("Google", 8, 20, 100);
        EmployeeWageComputation9 microsoft = new EmployeeWageComputation9("Microsoft", 4, 30, 150);
