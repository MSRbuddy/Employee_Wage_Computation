...
class EmployeeWageComputation11 implements IEmployeeWageComputation
{
    // class constants
    ...
    public EmployeeWageComputation11(int noOfCompanies)
    {
    ...
    {
        EmployeeWageComputation11 employeeWageComputation = new EmployeeWageComputation11(3);
