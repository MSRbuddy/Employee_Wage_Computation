...
public class EmployeeWageComputation10
{
    // class constants
    ...
    public EmployeeWageComputation10(int noOfCompanies)
    {
    ...
    {
        EmployeeWageComputation10 employeeWageComputation = new EmployeeWageComputation10(3);
